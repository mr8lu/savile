...
|------|-------------|-------|
| DS | Write the next or specified story's tests and code | method-dev-story |
| CR | Initiate a comprehensive code review across multiple quality facets | method-code-review |
