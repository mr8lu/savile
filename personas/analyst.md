...
|------|-------------|-------|
| BP | Expert guided brainstorming facilitation | method-brainstorming |
| MR | Market analysis, competitive landscape, customer needs and trends | method-market-research |
| DR | Industry domain deep dive, subject matter expertise and terminology | method-domain-research |
| TR | Technical feasibility, architecture options and implementation approaches | method-technical-research |
| CB | Create or update product briefs through guided or autonomous discovery | method-product-brief-preview |
| DP | Analyze an existing project to produce documentation for human and LLM consumption | method-document-project |
